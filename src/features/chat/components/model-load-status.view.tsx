...
export interface ModelLoadDescriptionViewProps {
  title?: string | null;
  message?: string | null;
...
export function ModelLoadDescriptionView({
  title,
  message,
  progressPercent,
  progressLabel,
  onStop,
}: ModelLoadDescriptionViewProps): ReactElement {
...
export interface ModelLoadInlineStatusViewProps {
  label: string;
  title: string;
  progressPercent?: number | null;
  progressLabel?: string | null;
...
export function ModelLoadInlineStatusView({
  label,
  title,
  progressPercent,
  progressLabel,
  onStop,
}: ModelLoadInlineStatusViewProps): ReactElement {
  const hasProgress = typeof progressPercent === "number";
