...
export interface RecipeStudioHeaderViewProps {
  ...
  onSetEditingWorkflowName: (value: boolean) => void;
  onWorkflowNameChange: (value: string) => void;
  onWorkflowNameSubmit: () => void;
  onWorkflowNameCancel: () => void;
...
export const MOCK_RECIPE_STUDIO_HEADER_PROPS: RecipeStudioHeaderViewProps = {
  activeView: "editor",
  saveLoading: false,
  saveTone: "success",
  savedAtLabel: "Saved 2 minutes ago",
  workflowName: "My Awesome Recipe",
  warnings: [],
  supportsEasyMode: true,
  editingWorkflowName: false,
  onSetEditingWorkflowName: () => {},
  onWorkflowNameChange: () => {},
  onWorkflowNameSubmit: () => {},
  onWorkflowNameCancel: () => {},
  onViewChange: () => {},
  onSaveRecipe: () => {},
};

export function RecipeStudioHeaderView({
  activeView,
  saveLoading,
  saveTone,
  savedAtLabel,
  ...
  onViewChange,
  onSaveRecipe,
}: RecipeStudioHeaderViewProps): ReactElement {
      ...
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="flex min-w-0 items-center gap-2">
          {editingWorkflowName ? (
            ...
            <button
              type="button"
              onClick={() => onSetEditingWorkflowName(true)}
