...
function renderNodeBody(
  ...
  if (config && isInlineConfig(config)) {
    if (config.kind === "sampler") {
      return <InlineSampler config={config} onUpdate={onUpdateConfig} />;
    }
    ...
    if (config.kind === "llm") {
      return <InlineLlm config={config} onUpdate={onUpdateConfig} />;
    }
    if (config.kind === "expression") {
      return <InlineExpression config={config} onUpdate={onUpdateConfig} />;
    }
    if (config.kind === "seed") {
      return <InlineSeed config={config} onUpdate={onUpdateConfig} />;
    }
  }
...
export const RecipeNodeView = memo(function RecipeNodeView({
  ...
  onUpdateConfig,
  onToggleLlmAux,
}: RecipeNodeViewProps): ReactElement {
