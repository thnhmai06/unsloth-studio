...
export interface ChangePasswordPageViewProps {
  authFormComponent: ReactNode;
}

export function ChangePasswordPageView({ authFormComponent }: ChangePasswordPageViewProps) {
  return (
